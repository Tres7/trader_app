...
const THUMB_OFFSET = (OPTION_WIDTH - THUMB_SIZE) / 2;
...
export function ThemeToggle() {
  ...
  const translateX = useSharedValue(activeIndex * OPTION_WIDTH + THUMB_OFFSET);

  React.useEffect(() => {
    translateX.value = withTiming(activeIndex * OPTION_WIDTH + THUMB_OFFSET, { duration: 200 });
